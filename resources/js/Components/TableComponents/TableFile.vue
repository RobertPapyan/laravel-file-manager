...
<template>
    <tr v-if="!cardView" class="border-t border-t-1 border-custom-blue-light hover:bg-custom-gray-bg cursor-pointer select-none" :class="selected? 'bg-custom-gray-bg':''">
